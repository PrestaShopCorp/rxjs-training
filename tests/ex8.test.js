...
describe("Exercice8", () => {
  ...
  it("Emit a value each time the value to display changes", (done) => {
    ...
    of({ hour: 18, minute: 30, second: 57 })
      .pipe(delay(51))
      .subscribe((t) => clockSubject.next(t), null, null);

    of({ hour: 18, minute: 30, second: 58 })
      .pipe(delay(56))
      .subscribe((t) => clockSubject.next(t), null, null);

    of(23)
      .pipe(delay(60))
      .subscribe((t) => this.weatherService.tempSensor.next(t), null, null);

    of({ hour: 18, minute: 30, second: 59 })
      .pipe(delay(65))
      .subscribe((t) => clockSubject.next(t), null, null);

    of({ hour: 18, minute: 31, second: 0 })
      .pipe(delay(70))
      .subscribe((t) => clockSubject.next(t), null, null);

    of({ hour: 18, minute: 31, second: 1 })
      .pipe(delay(80))
      .subscribe((t) => clockSubject.next(t), null, null);
