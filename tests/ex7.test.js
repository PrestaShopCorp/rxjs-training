...
describe("Exercice7", () => {
    ...
    beforeEach(() => {
        ...
        this.exercice = new Exercice7(this.gpsService, this.weatherService, this.atomicClockService);
    });

    it('Return an observable', () => {
        expect(this.exercice.initDisplay(['safe-address'])).toBeInstanceOf(Observable);
    });
    ...
    it("Emit a value with the correct format in less than 90ms", (done) => {
        ...
        this.exercice.initDisplay().pipe(toArray())
            .subscribe(
                msgs => {
